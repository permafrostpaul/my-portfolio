...
import { Send, Mail, Briefcase, Github, Linkedin, Facebook, Instagram } from 'lucide-react';
                    ...
                    <div className="lg:col-span-3 bg-slate-50 p-8 rounded-2xl shadow-lg border border-slate-100">
                        {isSent ? (
                            <div className="text-center flex flex-col justify-center items-center h-full">
                                ...
                                <p className="text-slate-600 mb-6">Thanks for reaching out. I'll get back to you shortly.</p>
                                <button
                            ...
                            <form ref={form} onSubmit={sendEmail}>
                                ...
                                <div className="mt-8">
                                    <button type="submit" disabled={isSending} className="w-full inline-flex items-center justify-center px-8 py-3 bg-blue-600 text-white font-bold rounded-lg shadow-lg hover:bg-blue-700 transition-all duration-300 transform hover:scale-105 disabled:bg-slate-400 disabled:scale-100">
